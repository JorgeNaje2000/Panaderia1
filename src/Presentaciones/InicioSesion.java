...
public class InicioSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lbImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 240, 170));
        ...
        jLabel3.setText("Panaderia bizcochitos");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 280, -1));
        ...
        if (intento<5) {
            try {
                ...
                if (tipo.equals("Admin")) {
                    ...
                    P=new Principal(tipo);
                    P.setVisible(true);
                } else if (tipo.equalsIgnoreCase("panadero")) {
                    JOptionPane.showMessageDialog(null, "Bienvenido "+txtUsuario.getText(), "Inicio de Sesion", JOptionPane.INFORMATION_MESSAGE);
                    P=new Principal(tipo);
                    P.setVisible(true);
                } else{
